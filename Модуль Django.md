...
## Как наше приложение и Админ-панель


Давайте разберемся с вашими запросами по порядку. Ваша задача заключается в том, чтобы подключить административную панель в Django, русифицировать её, создать первого суперпользователя и управлять вашими моделями `Category`, `Tag`, `Card`, и `CardTags`
...
## Как добавить в Админке кнопку "Смотреть на сайте" (`get_absolute_url`)
...
## Кастомизация представления модели в Админке
...
## Пагинация и модерация карточек в Админке
...
## Свое действие в выпадающем меню в Админке
