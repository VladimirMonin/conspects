...
2. **Электронная коммерция и управление заказами:**
   - Описывают жизненный цикл заказа: "в корзине", "оформлен", "оплачен", "отправлен", "доставлен", "возвращен".
...
5. **Процесс зачисления в университет**
   - Создайте диаграммудеятельности, которая показывает процесс зачисления студента в университет. Этот процесс должен начинаться с подачи заявления и заканчиваться зачислением или отказом.